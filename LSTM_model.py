...
class LSTM_Model(object):
    ...
    def __init__(self, config, GloVe_embeddings, debug=False, mode="training"):
        ...
        self.add_input() #weights and biases
    ...
    def add_input(self):
        ...
        self.input = tf.concat([imgs_input, captions_input],1)
    ...
    def add_loss_op(self):
        ...
        labels = tf.reshape(self.labels_ph, [-1]) #true labels
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(config.max_no_of_epochs):
            ...
            total_batch_loss.extend(batch_losses)
            ...
            if eval_result_dict["CIDEr"] > 0.70: #0.92:
            ...
            log("epoch loss: %f | BLEU4: %f  |  CIDEr: %f" % (epoch_loss,
                        eval_result_dict["Bleu_4"], eval_result_dict["CIDEr"]))
        with open('batch_loss', 'wb') as myfile:
            wr = csv.writer(myfile, quoting=csv.QUOTE_ALL)
            wr.writerow(total_batch_loss)
    #print("Batch losses")
