...
import sys
sys.path.append("/home/cul10kk/CS224n_project/coco/PythonAPI")
from pycocotools.coco import COCO

# add the "coco-caption" dir to the path so that "pycocoevalcap" can be found:
sys.path.append("/home/cul10kk/CS224n_project/coco/coco-caption")
sys.path.append("/home/cul10kk/CS224n_project/coco/coco-caption/pycocotools")
...
def get_max_caption_length(batch_size):
    ...
    caption_length_2_no_of_captions =\
            cPickle.load(open("/home/cul10kk/CS224n_project/coco/data/train_caption_length_2_no_of_captions"))
